...
- **Fixed**: Available-player answers now explicitly omit provider injury-status fields unless the user asks for injury detail; requested injury context must be checked against current web evidence and provider enums translated into plain language.
