...
- **Fixed**: Available-player assistant responses now omit injury detail unless the user asks for it; ESPN baseball injured-list codes are translated before they reach the response, and requested injury context must still be checked against current web evidence.
