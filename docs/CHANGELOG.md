...
- **Unchanged descriptor**: no tool name, annotation, or declared schema moved; every new field rides the existing passthrough objects. The description gains one sentence on category responses.
