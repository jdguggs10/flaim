...
export const metadata: Metadata = {
  ...
  description:
    'How to add Flaim as a Claude integration so you can ask about your ESPN, Yahoo, or Sleeper fantasy leagues directly in Claude.',
  alternates: {
    ...
    <div className="min-h-screen bg-background">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'How to add Flaim as a Claude integration for fantasy sports analysis.',
            step: [
              { '@type': 'HowToStep', name: 'Open Claude settings', text: 'Go to claude.ai and open Settings > Integrations.' },
              { '@type': 'HowToStep', name: 'Add integration', text: 'Click "Add Integration" and enter the Flaim MCP server URL: https://api.flaim.app/mcp' },
      ...
      <div className="container max-w-2xl mx-auto py-12 px-4">
        ...
        <p className="text-muted-foreground mb-8">
          Flaim connects to Claude as an integration, giving it read-only access to your ESPN, Yahoo, and Sleeper fantasy leagues. Once connected, you can ask Claude about your roster, matchups, standings, and more, all grounded in your actual league data.
        </p>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-1">
            ...
            <li>A Claude Pro, Team, or Enterprise plan (integrations aren&apos;t available on the free plan)</li>
          </ul>
        </section>
