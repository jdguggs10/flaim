...
export const metadata: Metadata = {
  title: 'Fantasy Sports Analysis: How Flaim Works | Flaim',
  description:
      ...
      <div className="container mx-auto max-w-2xl px-4 py-12">
        ...
        <section className="mb-10">
          ...
          <p className="mb-4 text-muted-foreground">
            When you connect Flaim to your AI assistant, it does not just expose raw data. The
            Flaim Skill is a set of instructions that shape how your AI reasons about fantasy
            sports. It covers three areas:
          </p>
          <div className="space-y-4">
            <div className="rounded-lg border bg-background p-4">
              <h3 className="mb-1 font-medium">Fantasy analyst reasoning</h3>
              <p className="text-sm text-muted-foreground">
                Your AI learns how to evaluate rosters in context: what positions matter most in
                your league format, where your team is weak, and how your scoring settings change
                player value. Instead of generic fantasy advice, Flaim grounds every answer in
                your actual league&apos;s rules and standings.
              </p>
            </div>
            <div className="rounded-lg border bg-background p-4">
              <h3 className="mb-1 font-medium">Web search when it matters</h3>
              <p className="text-sm text-muted-foreground">
                Your AI knows when to reach beyond your league data for current context. Injury
                reports, recent performance trends, schedule changes, and breaking news get
                layered on top of your league data so the answer reflects what is actually
                happening right now, not just what the box score says.
              </p>
            </div>
            <div className="rounded-lg border bg-background p-4">
              <h3 className="mb-1 font-medium">Smart tool orchestration</h3>
              <p className="text-sm text-muted-foreground">
                One question can pull from multiple tools automatically. Ask &ldquo;What is the
                biggest hole in my roster?&rdquo; and your AI inspects your roster, checks the
                waiver wire, looks up player details, and adds web context, all in the right
                order, without you specifying which tools to use.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="mb-4 text-muted-foreground">
            Flaim provides 9 read-only tools that give your AI access to your league data. These
            tools work the same way across all supported sports:
          </p>
          <div className="grid gap-2">
            {[
              { name: 'Roster', desc: 'Your team and your opponents\' teams, including starters, bench, and injured reserve.' },
              { name: 'Standings', desc: 'Current league standings with records, points, and rankings.' },
              { name: 'Matchups', desc: 'Current and upcoming head-to-head matchups with scores and projections.' },
              { name: 'Free Agents', desc: 'Available players on the waiver wire, filterable by position.' },
              { name: 'Transactions', desc: 'Recent adds, drops, trades, and waiver claims across the league.' },
              { name: 'Player Lookup', desc: 'Detailed info on specific players, including stats and availability.' },
              { name: 'League Info', desc: 'League settings like format, roster slots, scoring rules, and playoff structure.' },
              { name: 'League History', desc: 'Past season results, standings, and outcomes.' },
              { name: 'Leagues', desc: 'All connected leagues across platforms, with your defaults and preferences.' },
            ].map(({ name, desc }) => (
              <div key={name} className="flex gap-3 rounded-lg border bg-background p-3">
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            All tools are read-only. Flaim cannot make trades, drop players, or change anything
            in your leagues.
          </p>
        </section>
        ...
        <section id="football" className="mb-10 scroll-mt-20">
          ...
          <div className="rounded-lg border bg-muted/50 p-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>&ldquo;Who is the best available running back on my waiver wire?&rdquo;</li>
              <li>&ldquo;What players on my roster have a bye next week?&rdquo;</li>
              <li>&ldquo;Am I favored in my matchup this week?&rdquo;</li>
              <li>&ldquo;What trades have happened in my league recently?&rdquo;</li>
            </ul>
          </div>
        </section>
        ...
        <section id="baseball" className="mb-10 scroll-mt-20">
          ...
          <div className="rounded-lg border bg-muted/50 p-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>&ldquo;Who is the best available pitcher on the wire?&rdquo;</li>
              <li>&ldquo;Show me my roster and tell me who is underperforming.&rdquo;</li>
        ...
        <section id="basketball" className="mb-10 scroll-mt-20">
          ...
          <div className="rounded-lg border bg-muted/50 p-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>&ldquo;What player on my roster should I give up on?&rdquo;</li>
        ...
        <section id="hockey" className="mb-10 scroll-mt-20">
          ...
          <div className="rounded-lg border bg-muted/50 p-4">
            <h3 className="mb-2 font-medium">Example prompts</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>&ldquo;Show me my roster and who is on injured reserve.&rdquo;</li>
