...
- **Basketball (fba)** / **Hockey (fhl)**: Flaim stores the canonical start year (for example `2024` for the 2024-25 season) even though ESPN's upstream API uses the end year
