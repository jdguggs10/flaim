...
<div class="widget">
  <div class="header">
    ...
    <div class="header-actions">
      ...
      <a href="https://flaim.app/leagues?from=chatgpt" target="_blank" rel="noopener" class="edit-link" aria-label="Edit leagues" id="edit-link">
...
(function() {
  ...
  var LEAGUES_URL = 'https://flaim.app/leagues?from=chatgpt';
  ...
  async function refreshLeagues(e) {
    ...
    try {
      ...
      setRefreshStatus('Refresh failed. <a href="https://flaim.app/leagues?from=chatgpt" target="_blank" rel="noopener">Open leagues</a>.', 'error');
    } finally {
