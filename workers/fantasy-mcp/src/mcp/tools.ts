...
const searchPlayerEntrySchema = looseObject({
  ...
  league_status: z.string().nullable().optional().describe('ROSTERED, FREE_AGENT, or null when unresolved: on ESPN/Yahoo this means credentials or rosters were unavailable; on Sleeper it means rosters were unavailable or rostering was ambiguous'),
